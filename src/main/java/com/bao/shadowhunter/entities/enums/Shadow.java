...
public enum Shadow {
    ...
    METAMORPH(new PlayerCard(ShadowHunterConstants.TEAM_RED_THUMBNAIL, ShadowHunterConstants.TEAM_RED, "Metamorph", ShadowHunterConstants.TEAM_RED_WIN_CONDITION, ShadowHunterConstants.METAMORPH_ABILITY, 11, "https://i.imgur.com/WzoZc8q.jpeg")),
